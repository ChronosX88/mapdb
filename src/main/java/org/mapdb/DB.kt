...
//        }
    ...
    class TreeSetMaker<E>(
        ...
        override fun open2(catalog: SortedMap<String, String>): NavigableSet<E> {
            return maker.open2_0(catalog).keys as NavigableSet<E>
        }

        override fun create2(catalog: SortedMap<String, String>): NavigableSet<E> {
            return maker.create2_0(catalog).keys as NavigableSet<E>
        }
    ...
    class HashSetMaker<E>(
        ...
        override fun open2(catalog: SortedMap<String, String>): HTreeMap.KeySet<E> {
            return maker.open2_0(catalog).keys as HTreeMap.KeySet<E>
        }

        override fun create2(catalog: SortedMap<String, String>): HTreeMap.KeySet<E> {
            return maker.create2_0(catalog).keys as HTreeMap.KeySet<E>
        }
    ...
    abstract class Maker<E>(){
        ...
        internal fun verify0(){verify()}
        internal fun create2_0(catalog:SortedMap<String,String>) = create2(catalog)
        internal fun open2_0(catalog:SortedMap<String,String>) = open2(catalog)
